...
public class Layout {
    ...
    private void addSeat(String seatNumber, int row, int column, Seat seat) {
    ...
    public Map<String, Seat> getSeatsByNumber() {
        return seatsByNumber;
    }

    public Map<Integer, Map<Integer, Seat>> getSeatsByPosition() {
